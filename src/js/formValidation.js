...
function validate() {
  if(validate_name(document.form_contatti.input_name) == true) { //se il nome è giusto prosegui
    settaBordoStatus(document.form_contatti.input_name, "si"); //se il nome è giusto metti bordo verde
    if(validate_email(document.form_contatti.input_email) == true) { //se la mail è giusta prosegui
      settaBordoStatus(document.form_contatti.input_email, "si"); //se la mail è giusta metti bordo verde
...
function validate_email(input_email) {
  ...
  if (!(input_email.value.match(mailformat)) ) {
    //alert con errore
    alert("Il formato della mail inserita è errata!" );
    //messaggio console con errore
